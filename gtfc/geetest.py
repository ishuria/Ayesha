...
class Crack():
    def __init__(self,username,password):
        self.url = 'https://exchange.fcoin.com/u/login'
    ...
    def open(self):
        ...
        username_btn = self.wait.until(EC.presence_of_element_located((By.NAME, 'email')))
        print(222)
        password_btn = self.wait.until(EC.presence_of_element_located((By.NAME, 'password')))
        print(333)
        sign_in_btn = self.wait.until(EC.presence_of_element_located((By.CLASS_NAME, 'sc-htoDjs')))
...
if __name__ == '__main__':
    print('开始验证')
    crack = Crack(u'recoxq@163.com',u'oy897874')
    crack.crack()
    print('验证成功')